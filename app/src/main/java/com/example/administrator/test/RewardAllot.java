...
public class RewardAllot {
    ...
    String[] mRank = {
            "1","2","3","4","5","6",
            "7-9","10-12","13-18","19-24","25-30","31-36","37-42","43-48",
            "49-54","55-60","61-66","67-72","73-78","79-84","85-90","91-96","97-102","103-108",
            "109-114","115-120","121-132","133-144","145-156","157-168","169-180","181-192"
    };
...
//            index = 26;
//        else if(index >= 132 && index <= 143)
//            index = 27;
//        else if(index >= 144 && index <= 155)
//            index = 28;
//        else if(index >= 156 && index <= 167)
//            index = 29;
//        else if(index >= 168 && index <= 179)
//            index = 30;
//        else if(index >= 180 && index <= 191)
//            index = 31;
     ...
     * @return 队列容量
     */
    public int getListSize(int count){
        if(count <3 )
            return 0;
