            ...
            try {
                ...
                if (tDate != null) {
                    ...
                    if (tDate.before(thisYear)) {
                        ...
                        if (dTime < tMin) {
//                            display = ToolUtil.sContext.getString(R.string.time_just);
                        } else if (dTime < tHour) {
//                            display = ToolUtil.sContext.getString(R.string.time_minutes_ago, (int) Math.ceil(dTime / tMin));
                        } else if (dTime < tDay && tDate.after(yesterday)) {
//                            display = ToolUtil.sContext.getString(R.string.time_hour_ago, (int) Math.ceil(dTime / tHour));
...
//        re_StrTime.append(GetStrSecondFmt(cc_time, "MM")).append(ToolUtil.sContext.getString(R.string.month));
...
//                        display = ToolUtil.sContext.getString(R.string.today);
                    } else if (tDate.after(beforeYes) && tDate.before(yesterday)) {
//                        display = ToolUtil.sContext.getString(R.string.yesterday);
                    } else {
//                        SimpleDateFormat halfDf = new SimpleDateFormat("dd" + ToolUtil.sContext.getString(R.string.day));
//                        display = halfDf.format(tDate);
                    }
                }
            } catch (Exception e) {
